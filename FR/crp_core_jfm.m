function [lag_crps,act,pos] = crp_core(recalls_matrix, subjects, list_length, ...
...
[lag_crps,act,pos] = apply_by_index_crp(@crp_for_subj, subjects, 1, ...
                          {recalls_matrix, from_mask_rec, to_mask_rec, ...
                           from_mask_pres, to_mask_pres}, ...
                          list_length);


function [subj_crp,actuals_counts,possibles_counts] = crp_for_subj(recalls, from_mask_rec, to_mask_rec, ...
